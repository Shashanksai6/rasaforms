...
class ValidateRestaurantForm(Action):
    ...
    def run(
        ...
        required_slots = ["name", "number","region","car_brand","gear","model","colourin"]
...
class ActionSubmit(Action):
    ...
    def run(
        ...
        dispatcher.utter_message(template="utter_details_thanks",
                                 ...
                                 Location=tracker.get_slot("region"),
                                 Carbrand=tracker.get_slot("car_brand"),
                                 Gear=tracker.get_slot("gear"),
                                 Model=tracker.get_slot("model"),
                                 Colourin=tracker.get_slot("colourin"))
